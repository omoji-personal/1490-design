...
<tr><td>Hood</td><td>Vent-A-Hood PRH18-342SS-BK (42″, 900 CFM Magic Lung dual blower, matte black custom)</td><td>Order via CDGA or AJ Madison; ~$3,433 base + ~10% BK custom upcharge; 6-8 wk lead</td></tr>
...
<tr><td>Lighting</td><td>Overhead pendant (Nelson Saucer Bubble white ★ / Formakami JH5 black / Rejuvenation Hartwell brass) + matte-dark floor lamp (Rejuvenation Cylinder ORB ★ per §6a F2 rebalance) + brass table lamps. LR-SCONCES carries the warm-metal anchor; floor lamp is the matte-dark counterpoint.</td></tr>
</table></div>
