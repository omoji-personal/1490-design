...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  @media (max-width: 720px) {{
    ...
    /* R3-C1: complete the wrapped-table reset so the outer .table-wrapper owns
     * the horizontal scroll while the inner <table> reflows normally (matches
     * sourcing_render_html.py and build_pages.py). */
